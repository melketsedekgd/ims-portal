    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description: "text-[13px] text-muted-foreground dark:text-muted-foreground leading-snug",
          actionButton:
            "group-[.toast]:bg-primary group-[.toast]:text-primary-foreground",
          cancelButton:
            "group-[.toast]:bg-muted group-[.toast]:text-muted-foreground",
          closeButton: 
            "!opacity-100 !bg-transparent !border-none !text-muted-foreground hover:!text-slate-700 dark:hover:!text-slate-200 !absolute !right-3 !top-3 !translate-x-0 !translate-y-0",
      ...
      icons={{
        ...
        warning: (
          <div className="relative">
            ...
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white dark:bg-zinc-900 shadow-[0_2px_12px_rgb(0,0,0,0.06)] border border-slate-50 dark:border-zinc-800">
              <Warning className="h-5 w-5 text-amber-500" strokeWidth={2.5} />
            </div>
          </div>
        ),
        error: (
        ...
        loading: (
          <div className="relative">
            ...
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white dark:bg-zinc-900 shadow-[0_2px_12px_rgb(0,0,0,0.06)] border border-slate-50 dark:border-zinc-800">
              <CircleNotch className="h-5 w-5 text-muted-foreground animate-spin" strokeWidth={2.5} />
            </div>
          </div>
        ),
      }}
