...
const actions = [
  { id: 1, title: "Submit Q3 Risk Review", due: "In 2 days", priority: "high", icon: WarningCircle },
  { id: 2, title: "Upload InfoSec Evidence", due: "In 5 days", priority: "medium", icon: Clock },
  { id: 3, title: "Approve KPI Target Changes", due: "Next week", priority: "low", icon: CheckCircle },
]

export function PendingActions({ employeeId, refreshKey }: { employeeId?: string, refreshKey?: number }) {
  return (
    <Card>
      <CardHeader>
